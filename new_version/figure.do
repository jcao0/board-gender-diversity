// Macros ---------
global results   = "/Volumes/Research/gender"

import delimited "$results/Figure_1/result.csv", clear
...
graph export "$results/Figure_1/female_board.pdf", as(pdf) replace


import delimited "$results/Figure_2/result.csv", clear
...
twoway (scatter coefficient2 event, mcolor(green) msize(small) msymbol(diamond)) ///
	   ...
	   xline(-0.5, lcolor(gs12) lpattern(dash) lwidth(thin)) ///
	   yline(0, lcolor(gs12) lpattern(dash) lwidth(thin))	   
graph export "$results/Figure_2/female_board.pdf", as(pdf) replace

import delimited "$results/Figure_3/result.csv", clear
...
twoway (scatter coefficient2 event, mcolor(green) msize(small) msymbol(diamond)) ///
	   ...
	   xline(-0.5, lcolor(gs12) lpattern(dash) lwidth(thin)) ///
	   yline(0, lcolor(gs12) lpattern(dash) lwidth(thin))	   
graph export "$results/Figure_3/female_board.pdf", as(pdf) replace


import delimited "$results/Figure_4/result.csv", clear
...
twoway (scatter coefficient2 event, mcolor(green) msize(small) msymbol(diamond)) ///
	   ...
	   xline(-0.5, lcolor(gs12) lpattern(dash) lwidth(thin)) ///
	   yline(0, lcolor(gs12) lpattern(dash) lwidth(thin))	   
graph export "$results/Figure_4/female_board.pdf", as(pdf) replace


import delimited "$results/Figure_5/result.csv", clear
...
twoway (scatter coefficient2 event, mcolor(green) msize(small) msymbol(diamond)) ///
	   ...
	   xline(-0.5, lcolor(gs12) lpattern(dash) lwidth(thin)) ///
	   yline(0, lcolor(gs12) lpattern(dash) lwidth(thin))	   
graph export "$results/Figure_5/female_board.pdf", as(pdf) replace


import delimited "$results/Figure_6/result.csv", clear
...
twoway (scatter coefficient2 event, mcolor(green) msize(small) msymbol(diamond)) ///
	   ...
	   xline(-0.5, lcolor(gs12) lpattern(dash) lwidth(thin)) ///
	   yline(0, lcolor(gs12) lpattern(dash) lwidth(thin))	   
graph export "$results/Figure_6/female_board.pdf", as(pdf) replace



import delimited "$results/SSC_board_gender_policy_spillovers/result.csv", clear
twoway (scatter coefficient2 event, mcolor(green) msize(small) msymbol(diamond)) ///
	   (line coefficient2 event, lcolor(green) lwidth(thin) lpattern(dash)) ///
       (rcap ub2 lb2 event, lcolor(green) lwidth(thin)) ///
	   (scatter coefficient1 event, mcolor(orange) msize(small) msymbol(circle)) ///
...
graph export "$results/SSC_board_gender_policy_spillovers/female_board.pdf", as(pdf) replace
...
import delimited "$results/Figure_A2/results_staggered_did.csv", clear
...
twoway (scatter coefficient event_time, mcolor(green) msize(small) msymbol(diamond)) ///
	   ...
	   xline(-0.5, lcolor(gs12) lpattern(dash) lwidth(thin)) ///
	   yline(0, lcolor(gs12) lpattern(dash) lwidth(thin))	   
graph export "$results/Figure_A2/results_staggered_did.pdf", as(pdf) replace
...
import delimited "$results/Figure_A2/results_borusyak.csv", clear
replace event_time = "-1" if event_time == "-Inf"
destring event_time, replace
...
twoway (scatter coefficient event_time, mcolor(green) msize(small) msymbol(diamond)) ///
	   ...
	   xline(-0.5, lcolor(gs12) lpattern(dash) lwidth(thin)) ///
	   yline(0, lcolor(gs12) lpattern(dash) lwidth(thin))	   
graph export "$results/Figure_A2/results_borusyak.pdf", as(pdf) replace
