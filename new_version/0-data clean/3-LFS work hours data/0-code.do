...
**step 1 import
clear
import excel "$db/3-LFS work hours data/lfsq_ewhuis.xlsx", sheet("for stata") firstrow clear
...
**step 3
merge m:1 geo using "$db/3-LFS work hours data/policy.dta"
keep if _merge==3
drop _merge
...
export delimited using "$db/3-LFS work hours data/data_hr.csv", replace
restore
