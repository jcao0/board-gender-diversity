...
set more off
clear
global db "/Users/hanyuling/Desktop/gender/0-data clean"

**step 1
clear
import excel "$db/2-LFS full time employment data/lfsq_epgais.xlsx", sheet("for stata") firstrow
...
**step 3
*bring in policy
merge m:1 geo using "$db/2-LFS full time employment data/policy.dta"
keep if _merge==3
drop _merge
...
export delimited using "$db/2-LFS full time employment data/data_ft.csv", replace
restore
